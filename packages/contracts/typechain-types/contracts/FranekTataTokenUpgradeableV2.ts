...
export interface FranekTataTokenUpgradeableV2Interface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface FranekTataTokenUpgradeableV2 extends BaseContract {
  connect(runner?: ContractRunner | null): FranekTataTokenUpgradeableV2;
  waitForDeployment(): Promise<this>;

  interface: FranekTataTokenUpgradeableV2Interface;
